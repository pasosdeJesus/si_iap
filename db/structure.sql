      ...
      BEGIN
        RETURN region_de_depmun(
          (SELECT u.departamento_id FROM cor1440_gen_actividad AS a
            LEFT JOIN msip_ubicacionpre AS u ON a.ubicacionpre_id=u.id
      ...
      BEGIN
        RETURN region_de_depmun(
          (SELECT u.id_departamento FROM sivel2_gen_caso AS c
            LEFT JOIN msip_ubicacion AS u ON c.id=u.id_caso 
            WHERE c.id=pcaso_id),
    ...
    AS $$
      BEGIN
        RETURN region_de_depmun(NULL, (SELECT MIN(municipiotrab_id) 
          FROM msip_municipiotrab_orgsocial WHERE orgsocial_id=porgsocial_id));
      END; 
      $$;
...
--
-- Name: msip_municipiotrab_orgsocial; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.msip_municipiotrab_orgsocial (
...
--
-- Name: msip_oficina regionsjr_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.actividad_solicitud
    ADD CONSTRAINT fk_rails_05f65435db FOREIGN KEY (solicitud_id) REFERENCES public.msip_solicitud(id);
...
ALTER TABLE ONLY public.accionorg_anexo
    ADD CONSTRAINT fk_rails_17edfe17e4 FOREIGN KEY (anexo_id) REFERENCES public.msip_anexo(id);
...
--
-- Name: msip_solicitud fk_rails_24615f9c38; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_solicitud
    ADD CONSTRAINT fk_rails_24615f9c38 FOREIGN KEY (estadosol_id) REFERENCES public.msip_estadosol(id);
...
--
-- Name: msip_orgsocial fk_rails_28272d4df3; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_orgsocial fk_rails_3e3d5cba6f; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_municipiotrab_orgsocial fk_rails_4b604ed742; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_municipiotrab_orgsocial
    ADD CONSTRAINT fk_rails_4b604ed742 FOREIGN KEY (orgsocial_id) REFERENCES public.msip_orgsocial(id);
...
--
-- Name: msip_orgsocial fk_rails_722b19abd0; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_solicitud_usuarionotificar fk_rails_798728a770; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_orgsocial fk_rails_940da8a93a; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_solicitud_usuarionotificar fk_rails_a2745aecdb; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_solicitud_usuarionotificar
    ADD CONSTRAINT fk_rails_a2745aecdb FOREIGN KEY (solicitud_id) REFERENCES public.msip_solicitud(id);


--
-- Name: msip_municipiotrab_orgsocial fk_rails_a2df6a06c8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_municipiotrab_orgsocial
    ADD CONSTRAINT fk_rails_a2df6a06c8 FOREIGN KEY (municipiotrab_id) REFERENCES public.msip_municipio(id);
...
ALTER TABLE ONLY public.cor1440_gen_actividad_etiqueta
    ADD CONSTRAINT fk_rails_a69991fcad FOREIGN KEY (etiqueta_id) REFERENCES public.msip_etiqueta(id);
...
ALTER TABLE ONLY public.accionorg_orgsocial
    ADD CONSTRAINT fk_rails_b6d48c8dbe FOREIGN KEY (orgsocial_id) REFERENCES public.msip_orgsocial(id);
...
--
-- Name: msip_solicitud fk_rails_c076bc4b48; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: msip_orgsocial fk_rails_da08cf875b; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_orgsocial
    ADD CONSTRAINT fk_rails_da08cf875b FOREIGN KEY (tipoorg_id) REFERENCES public.msip_tipoorg(id);
...
--
-- Name: msip_orgsocial fk_rails_dcc54d7f50; Type: FK CONSTRAINT; Schema: public; Owner: -
--
