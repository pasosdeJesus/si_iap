  ...
  class OrgsocialesController < Heb412Gen::ModelosController
    ...
    def self.calcula_titulo(tipoorg_id, plural=true)
      if !plural && tipoorg_id>=1 && tipoorg_id<=5
        return Msip::Tipoorg.find(tipoorg_id).nombre.capitalize
      end
      case tipoorg_id
      when 1
    ...
    def index
      ...
      if params && params[:filtro] && params[:filtro][:bustipoorg_id]
        ...
        @titulo = Msip::OrgsocialesController::calcula_titulo(
    ...
    def nuevo_intermedio(registro)
      ...
      if params && params[:filtro] && params[:filtro][:bustipoorg_id]
        ...
        @titulo = nueva + Msip::OrgsocialesController::calcula_titulo(t, false)
    ...
    def editar_intermedio(registro, usuario_actual_id)
      ...
      if registro.tipoorg
        @titulo = "Editar " + Msip::OrgsocialesController::calcula_titulo(
